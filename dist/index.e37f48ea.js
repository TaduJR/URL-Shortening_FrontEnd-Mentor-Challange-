...
var _shortenURLView = require("./views/shortenURLView");
var _shortenURLViewDefault = parcelHelpers.interopDefault(_shortenURLView);
var _shortnedURLView = require("./views/shortnedURLView");
var _shortnedURLViewDefault = parcelHelpers.interopDefault(_shortnedURLView);
const controlShortenURL = async function() {
    try {
        const inputURL = _shortenURLViewDefault.default.getQuery();
        if (!inputURL) return;
        _shortenURLViewDefault.default.renderSpinner();
        await _model.loadShortenURL(inputURL);
        _shortenURLViewDefault.default.deRenderSpinner();
        console.log(_model.state.shortenedURL);
        _shortnedURLViewDefault.default.render(_model.state.shortenedURL);
    } catch (err) {
        _shortenURLViewDefault.default.deRenderSpinner();
        _shortenURLViewDefault.default.renderError(err.error);
    }
};
const init = function() {
    _shortenURLViewDefault.default.addHandlerShortenSubmit(controlShortenURL);
    _shortenURLViewDefault.default.addHandlerError();
};
init();

},{"./model":"Y4A21","./views/shortenURLView":"DIk3d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/shortnedURLView":"g5bhE"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "loadShortenURL", ()=>loadShortenURL
);
...
const loadShortenURL = async function(url) {
    const data = await _helpers.getJSON(url);
...
const getJSON = async function(url) {
    try {
        const fetchPro = fetch(`${_config.API_URL}${url}`);
...
},{}],"DIk3d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class ShortenURLView {
    ...
    getQuery() {
        const inputURL = this._parentElement.querySelector(".section__links--shortner-input").value;
        return inputURL;
    }
    renderSpinner() {
        this._parentElement.querySelector(".btn__shortner").classList.add("btn__shortner--loading");
        this._parentElement.querySelector(".btn__shortner").setAttribute("disabled", true);
    }
    deRenderSpinner() {
        this._parentElement.querySelector(".btn__shortner").classList.remove("btn__shortner--loading");
    ...
    addHandlerError() {
        ...
        document.addEventListener("keydown", function(e) {
            if (e.key === "Escape" && !modal.classList.contains("hidden")) this._closeErrorPopup();
        });
    }
...
exports.default = new ShortenURLView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g5bhE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new ShortnedURLView();
...
},{}]},["ddCAb","aenu9"], "aenu9", "parcelRequirefc24")
